...
class RobotState():
    """
        Has all state the robot and this will go update every time
    """

    def __init__(self, default_z):
        """
            Constructor of the state
            Args:
                default_Z (float): the pos z of the robot in the initia instance
        """
        self.velocity = np.array([0., 0.])
        self.yaw_rate = 0.
        self.robot_height = default_z
