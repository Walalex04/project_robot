...
def rotxyz(alpha, beta, gamma):
    """
    Create a 3x3 rotation matrix about the x,y,z axes using 
    euler angles, roll pitch yawl Rz Ry Rx respect to global axes
    """
    return (rotz(gamma).dot(roty(beta))).dot(rotx(alpha))
